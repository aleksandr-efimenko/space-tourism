...
export default function ModalWindowAboutMe({ setIsModalOpen }: { setIsModalOpen: (value: boolean) => void }) {
  ...
  return (
    <div className='absolute inset-0 heading5 text-center text-white'>
      <div className='absolute inset-0 z-40 bg-slate-500 opacity-80' onClick={() => closeModalAboutMe()}></div>

      <div
        className='relative top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2  bg-slate-800 w-10/12 md:w-3/5 h-1/4 
